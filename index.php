    ...
    <div class="container-fluid min-vh-100 lat-blkg px-4 konten" width="100%">
      ...
      <div class="row min-vh-100">
        <div class="container col-12">
          ...
          <div class="container col-12 border border-5 d-flex flex-wrap justify-content-evenly">
        ...
        <div class="container col-12 px-5">
          ...
          <div class="container">
            <div class="d-flex justify-content-center my-4">
              <a href="#" class="btn oren text-white rounded-pill fw-bold px-4" width="33%">Explore Recipes</a>
            </div>
          </div>
          <div class="container col-12 border border-5 d-flex flex-wrap justify-content-evenly">
            <div class="card-1 m-3 px-2">
              <div class="py-3 px-2 d-flex flex-column">
                <img src="img/quick_meal.png" alt="" class="img-fluid mb-2 align-self-center">
                ...
                <div class="d-flex justify-content-center">
                  <a href="#" class="btn oren text-white rounded-pill fw-bold px-4" width="33%">Quick Meal</a>
                </div>
              </div>
            </div>
            <div class="card-1 m-3 px-2">
              <div class="py-3 px-2 d-flex flex-column">
                <img src="img/high_protein.png" alt="" class="img-fluid mb-2 align-self-center">
                ...
                <div class="d-flex justify-content-center">
                  <a href="#" class="btn ijo text-white rounded-pill fw-bold px-4" width="33%">High Protein</a>
                </div>
              </div>
            </div>
            <div class="card-1 m-3 px-2">
              <div class="py-3 px-2 d-flex flex-column">
                <img src="img/light_and_fresh.png" alt="" class="img-fluid mb-2 align-self-center">
                ...
                <div class="d-flex justify-content-center">
                  <a href="#" class="btn oren text-white rounded-pill fw-bold px-4" width="33%">Light and Fresh</a>
                </div>
              </div>
            </div>
          </div>
